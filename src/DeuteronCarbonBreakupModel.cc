...
#include "TMath.h"
#include <math.h>
Double_t JediBreakupModel::SigmaUnpol(Double_t E, Double_t theta,
		Double_t Ex) {
...
Double_t JediBreakupModel::ThetaEx(Double_t* x, Double_t* par) {
	/*
	 * x[0]=theta
	 * x[1]=Ex
	 * par[0]=E
...
double JediBreakupModel::Phi(Double_t* x, Double_t* par) {
	/*
	 * x[0]=Phi
	 * par[0]=Py
	 * par[1]=E
...
Double_t JediBreakupModel::c1(Double_t theta,Double_t E) {
	return sqrt(113./E)*exp(1.5586-0.07178*(theta-40.)+4.0733e-4*pow(theta-40.,2));
}

Double_t JediBreakupModel::c2(Double_t theta, Double_t E) {
	return E/113*(62.214+0.30061*(theta-40)-0.004704*pow(theta-40.,2));
}

Double_t JediBreakupModel::c3(Double_t theta) {
	return 14.384-0.048676*(theta-40);
}

Double_t JediBreakupModel::c4(Double_t theta) {
	return 0.74342+0.0069414*(theta-40);
}

Double_t JediBreakupModel::c5(Double_t theta) {
	return c3(theta)*(0.070367-3.3534e-4*(theta-40)+1.1845e-5*(theta-40)*(theta-40)+1.1436e-6*pow(theta-40,3));
}

Double_t JediBreakupModel::Ay(Double_t E, Double_t theta,
		Double_t Ex) {
	return d1(theta,E)+d2(theta,E)*(Ex-E/2.);
}

Double_t JediBreakupModel::d1(Double_t theta, Double_t E) {
	return -1280./E/E+0.528*theta/E;
}

Double_t JediBreakupModel::d2(Double_t theta, Double_t E) {
