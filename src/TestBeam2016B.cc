...
TestBeam2016B::TestBeam2016B():fArmLength(1*CLHEP::m),fArmWidth(10*CLHEP::cm),fArmAngle(10*CLHEP::deg),fDetectorHeight(0) {
...
void TestBeam2016B::MakeSetup() {
	...
	G4double minDistance=25*CLHEP::cm;
	...
	auto logicHorizontalSupport=new G4LogicalVolume(solidSupport,man->FindOrBuildMaterial("G4_Al"),"Support");
	...
	new G4PVPlacement(rot1,G4ThreeVector(0,-3./2.*fArmWidth-minDistance+fDetectorHeight-fNy*fCrystalWidth/2,fArmLength/2).rotateY(-fArmAngle),logicHorizontalSupport,"Support",fLogicWorld,0,0,false);
	new G4PVPlacement(rot2,G4ThreeVector(0,-fArmWidth/2.-minDistance+fDetectorHeight-fNy*fCrystalWidth/2,fArmLength/2).rotateY(fArmAngle),logicHorizontalSupport,"Support",fLogicWorld,1,0,false);
	...
	new G4PVPlacement(0,G4ThreeVector(0,fArmWidth/2-minDistance+fDetectorHeight-fNy*fCrystalWidth/2,fArmLength/4),logicShortSupport,"Support",fLogicWorld,1,0,false);


	auto solidLongVerticalSupport=new G4SubtractionSolid("VerticalSupport",
			new G4Box("",fArmWidth/2,(fArmWidth+minDistance)/2,fArmWidth/2),
			new G4Box("",fArmWidth/4,(fArmWidth+minDistance),fArmWidth/4)
	);

	auto solidShortVerticalSupport=new G4SubtractionSolid("VerticalSupport",
			new G4Box("",fArmWidth/2,minDistance/2,fArmWidth/2),
			new G4Box("",fArmWidth/4,minDistance,fArmWidth/4)
	);
	...
	new G4PVPlacement(rot1,G4ThreeVector(0,-3./2.*fArmWidth-minDistance+fDetectorHeight+fArmWidth/2+(fArmWidth+minDistance)/2-fNy*fCrystalWidth/2,fArmLength-fArmWidth/2).rotateY(-fArmAngle),logicLongVerticalSupport,"Support",fLogicWorld,0,0,false);
	new G4PVPlacement(rot2,G4ThreeVector(0,-fArmWidth/2.-minDistance+fDetectorHeight+fArmWidth/2+minDistance/2-fNy*fCrystalWidth/2,fArmLength-fArmWidth/2).rotateY(fArmAngle),logicShortVerticalSupport,"Support",fLogicWorld,0,0,false);

	auto logicRight=Make2016BDetector("Right");
	auto logicLeft=Make2016BDetector("Left");

	new G4PVPlacement(rot1,G4ThreeVector(0,-3./2.*fArmWidth-minDistance+fDetectorHeight+fArmWidth/2+(fArmWidth+minDistance),fArmLength-fArmWidth/2).rotateY(-fArmAngle),logicRight,"Left",fLogicWorld,0,0,false);
	new G4PVPlacement(rot2,G4ThreeVector(0,-fArmWidth/2.-minDistance+fDetectorHeight+fArmWidth/2+minDistance,fArmLength-fArmWidth/2).rotateY(fArmAngle),logicLeft,"Right",fLogicWorld,0,1,false);
	...
	new G4PVPlacement(0,G4ThreeVector(0,fArmWidth-minDistance+fDetectorHeight-fNy*fCrystalWidth/2+2*CLHEP::cm,fArmLength/2),logicMonitor,"Monitor",fLogicWorld,0,0,0);
...
G4LogicalVolume* TestBeam2016B::Make2016BDetector(G4String name) {
