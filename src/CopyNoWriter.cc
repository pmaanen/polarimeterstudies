...
void CopyNoWriter::AddExtension(xercesc::DOMElement* volumeElement,
...
void CopyNoWriter::ExtensionWrite(xercesc::DOMElement* element)
{
...
void CopyNoWriter::ColorWrite(xercesc::DOMElement* volumeElement,
...
G4bool CopyNoWriter::BookAttribute(const G4VisAttributes* const ref)
{
  G4bool booking = true;
