...
void CosmicMuonGenerator::Generate(G4Event* E) {
	...
	auto oldPosition=fParticleGun->GetParticlePosition();
...
PrimaryEvent CosmicMuonGenerator::Generate() {
	...
	auto vx=fParticleGun->GetParticlePosition().getX()+fSpotsize.getX()*(G4UniformRand()-0.5);
	auto vy=fParticleGun->GetParticlePosition().getY()+fSpotsize.getY()*(G4UniformRand()-0.5);
	auto vz=fParticleGun->GetParticlePosition().getZ()+fSpotsize.getZ()*(G4UniformRand()-0.5);
