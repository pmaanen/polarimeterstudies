...
public:
	friend class G4ThreadLocalSingleton<JediPhysicsManager>;

	static JediPhysicsManager* GetInstance() {
	       static G4ThreadLocalSingleton<JediPhysicsManager> theInstance;
